...
/** 사용자가 직접 선택할 수 있는 시설 preset 목록이다. 일반 시설은 내부 기본값으로만 유지한다. */
export const SELECTABLE_FACILITY_KIND_OPTIONS: EditorFacilityKind[] = FACILITY_KIND_OPTIONS.filter((kind) => kind !== 'generic')
