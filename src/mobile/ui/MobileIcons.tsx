...
export function GearIcon({ className = 'h-5 w-5' }: MobileIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
export function MenuIcon({ className = 'h-5 w-5' }: MobileIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
export function PlusIcon({ className = 'h-5 w-5' }: MobileIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
export function CloseIcon({ className = 'h-5 w-5' }: MobileIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
export function MapPinIcon({ className = 'h-16 w-16' }: MobileIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
export function UndoIcon({ className = 'h-5 w-5' }: MobileIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
...
export function RedoIcon({ className = 'h-5 w-5' }: MobileIconProps) {
  return (
    <svg
      viewBox="0 0 24 24"
      aria-hidden="true"
